...
import {
  ...
  SERVER_GITHUB_OAUTH_CALLBACK_NEW_REPOSITORY,
...
async function main() {
  ...
  try {
    ...
    app.get(
      SERVER_GITHUB_OAUTH_LOGIN_NEW_REPOSITORY,
      githubLoginRedirect(SERVER_GITHUB_OAUTH_CALLBACK_NEW_REPOSITORY),
    );
    app.get(
      SERVER_GITHUB_OAUTH_CALLBACK_NEW_REPOSITORY,
      githubCallback(SERVER_GITHUB_OAUTH_CALLBACK_NEW_REPOSITORY, NEW_REPOSITORY_PATH),
    );
